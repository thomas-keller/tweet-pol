...
#
#slight modifications by Thomas Keller ~2016-4-15
#==============================================================================
library(smappR)
### ADDITIONAL FILTERS

users <- read.csv("~/postdoc/twitter_crap/temp/user_list_full.csv", stringsAsFactors=F)
...
#the website getGEO is pulling from is down, and this is an ancillary analysis that takes
#~3 days to pull the data for, do I really care?
